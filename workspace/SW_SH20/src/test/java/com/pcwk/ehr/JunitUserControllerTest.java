...
public class JunitUserControllerTest {
   ...
   MockMvc mockMvc;
     ...
     public void setUp()throws Exception{
        ...
        user01 = new UserVO("p27","최유빈27", "4321", Level.BASIC, 1, 0, "euloja5@naver.com", "날짜_사용안함");
        user02 = new UserVO("p270","최유빈270", "4321", Level.SILVER, 50, 2, "euloja5@naver.com", "날짜_사용안함");
        user03 = new UserVO("p2700","최유빈2700", "4321", Level.GOLD, 100, 31, "euloja5@naver.com", "날짜_사용안함");
     ...
     @Test
     public void idCheck() throws UnsupportedEncodingException, Exception{
    	 // 1. 기존 데이터 삭제
    	 // 2. 한건 입력
    	 // 3. idCheck()
